<?php add_action( 'vc_before_init', 'dtportfolio_tags_vc_map' );
function dtportfolio_tags_vc_map() {
	vc_map( array(
		"name" => esc_html__( "Single Portfolio - Tags", 'dtportfolio' ),
		"base" => "dtportfolio_tags",
