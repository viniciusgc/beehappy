<?php add_action( 'vc_before_init', 'dt_sc_post_date_vc_map' );
function dt_sc_post_date_vc_map() {

	vc_map( array(
		"name" => esc_html__( "Post - Date", 'designthemes-core' ),
		"base" => "dt_sc_post_date",
		"icon" => "dt_sc_post_date",
		"category" => DT_VC_CATEGORY,
		"description" => esc_html__("Show date of post",'designthemes-core'),
		"params" => array(
