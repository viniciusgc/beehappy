<?php add_action( 'vc_before_init', 'dt_sc_post_socials_vc_map' );
function dt_sc_post_socials_vc_map() {

	vc_map( array(
		"name" => esc_html__( "Post - Socials", 'designthemes-core' ),
		"base" => "dt_sc_post_socials",
		"icon" => "dt_sc_post_socials",
		"category" => DT_VC_CATEGORY,
		"description" => esc_html__("Show social share of post",'designthemes-core'),
		"params" => array(
