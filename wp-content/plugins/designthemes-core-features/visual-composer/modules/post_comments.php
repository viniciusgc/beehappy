<?php add_action( 'vc_before_init', 'dt_sc_post_comments_vc_map' );
function dt_sc_post_comments_vc_map() {

	vc_map( array(
		"name" => esc_html__( "Post - Comments", 'designthemes-core' ),
		"base" => "dt_sc_post_comments",
		"icon" => "dt_sc_post_comments",
		"category" => DT_VC_CATEGORY,
		"description" => esc_html__("Show comment of post",'designthemes-core'),
		"params" => array(
