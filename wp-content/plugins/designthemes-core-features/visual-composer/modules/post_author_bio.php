<?php add_action( 'vc_before_init', 'dt_sc_post_author_bio_vc_map' );
function dt_sc_post_author_bio_vc_map() {

	vc_map( array(
		"name" => esc_html__( "Post - Author Bio", 'designthemes-core' ),
		"base" => "dt_sc_post_author_bio",
		"icon" => "dt_sc_post_author_bio",
		"category" => DT_VC_CATEGORY,
		"description" => esc_html__("Show author biography of post",'designthemes-core'),
		"params" => array(
