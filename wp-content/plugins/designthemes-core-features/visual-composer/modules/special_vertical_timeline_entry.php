<?php add_action( 'vc_before_init', 'dt_sc_special_vc_timeline_entry_vc_map' );
function dt_sc_special_vc_timeline_entry_vc_map() {
	vc_map( array(
		"name" => esc_html__( "Timeline Entry", 'designthemes-core' ),
		"base" => "dt_sc_special_vc_timeline_entry",
		"icon" => "dt_sc_special_vertical_timeline",
		"category" => DT_VC_CATEGORY,
		'as_child' => array( 'only' => 'dt_sc_special_vertical_timeline' ),
		...
		"params" => array(
			...
			array(
				...
				'heading' => esc_html__( 'Icon Title', 'designthemes-core' ),
      			'admin_label' => true,
				'group' => esc_html__( 'Icon', 'designthemes-core' ),
				'description' => esc_html__( 'Enter icon title', 'designthemes-core' )
			),
			...
			# Content
      		...
      		array(
      			"type" => "textfield",
      			"heading" => esc_html__( "Button Link", 'designthemes-core' ),
      			"param_name" => "btn_link",
				'group' => esc_html__( 'Button', 'designthemes-core' )
      		)
		)
