<?php add_action( 'vc_before_init', 'dt_sc_post_likes_views_vc_map' );
function dt_sc_post_likes_views_vc_map() {

	vc_map( array(
		"name" => __( "Post - Likes & Views", 'designthemes-core' ),
		"base" => "dt_sc_post_likes_views",
		"icon" => "dt_sc_post_likes_views",
		"category" => DT_VC_CATEGORY,
		"description" => __("Show likes & views of post",'designthemes-core'),
		"params" => array(
