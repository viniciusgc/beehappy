<?php add_action( 'vc_before_init', 'dt_sc_post_related_article_vc_map' );
function dt_sc_post_related_article_vc_map() {

	vc_map( array(
		"name" => esc_html__( "Post - Related Article", 'designthemes-core' ),
		"base" => "dt_sc_post_related_article",
		"icon" => "dt_sc_post_related_article",
		"category" => DT_VC_CATEGORY,
		"description" => esc_html__("Show related article of post. Use only one for a page.",'designthemes-core'),
		"params" => array(
