...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'backup_e10763b0d14c3fac3412_20230123230657_archive.zip';
        const ARCHIVE_SIZE       = '357884181';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'e10763b-23230657';
        const SECONDARY_PACKAGE_HASH = 'c543ce5-23230657';
        const VERSION            = '1.5.1';
